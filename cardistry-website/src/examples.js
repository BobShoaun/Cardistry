  ...
  },
  {
    ...
    getInstance: () =>
      new Cardistry({
        ...
        states: [
          { ...stack(), delay: 400 },
          { ...spreadCenter(), duration: 300 },
          { ...stack(), delay: 400 },
          { ...spreadLeft(), duration: 300 },
          { ...stack(), delay: 400 },
          { ...spreadRight(), duration: 300 },
        ],
      }),
    code: `new Cardistry({
  target: ".example",
...
const setExample = example => {
  ...
  currInstance.play();
  // credits to hightlight.js
  document.getElementById("code").innerHTML = hljs.highlight(example.code, { language: "javascript" }).value;
